...
CREATE TABLE IF NOT EXISTS pulsera_qr (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS historial_acceso (
    ...
    FOREIGN KEY (pulsera_id) REFERENCES pulsera_qr(id) ON DELETE CASCADE
);

-- Insertar datos de prueba
INSERT INTO tutor (nombre, apellido, telefono, email, fecha_nacimiento, relacion_con_usuario) VALUES
...
INSERT INTO usuario (nombre, apellido, telefono, email, fecha_nacimiento, tutor_id, tiene_discapacidad, tipo_discapacidad) VALUES
...
INSERT INTO perfil_informacion (usuario_id, alergias, medicamentos, enfermedades_cronicas, grupo_sanguineo, contacto_emergencia, telefono_emergencia, observaciones_medicas, requiere_atencion_inmediata) VALUES
...
INSERT INTO pulsera_qr (codigo_unico, usuario_id, contador_accesos) VALUES
...
CREATE INDEX idx_usuario_tutor ON usuario(tutor_id);
CREATE INDEX idx_perfil_usuario ON perfil_informacion(usuario_id);
CREATE INDEX idx_pulsera_usuario ON pulsera_qr(usuario_id);
CREATE INDEX idx_pulsera_codigo ON pulsera_qr(codigo_unico);
CREATE INDEX idx_historial_pulsera ON historial_acceso(pulsera_id);
